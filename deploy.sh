...
GOOS=linux GOARCH=amd64 go build -o config/db/seeds/enterprise -tags enterprise config/db/seeds/enterprise.go config/db/seeds/seeds.go

# build seeds.go
echo "Building main seeds..."
GOOS=linux GOARCH=amd64 go build -o config/db/seeds/main config/db/seeds/main.go config/db/seeds/seeds.go
